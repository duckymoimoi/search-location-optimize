...
> **Tài liệu thiết kế pilot/lịch sử.** Các số corpus/query v3 bên dưới không phải trạng thái hiện hành. Đọc [Current state](../as-built/CURRENT_STATE.md), [System design](../specs/SYSTEM_DESIGN.md), [Technical spec](../specs/TECHNICAL_SPEC.md) và [Training/nâng cấp retrieval](../specs/TRAINING_AND_RETRIEVAL_PROTOCOL.md). Demo hiện có Stage 1 và geo-v5; geo-v6 mới là đề xuất chưa triển khai.
